...
//数据库配置
$dbServerArray = array(
        'Default' => 'mysql:host=rm-bp1sytr570613fyy0.mysql.rds.aliyuncs.com;port=3306;dbname=cd_match|changdong|Changdong123!@#',
        'yd_finance2' => 'mysql:host=rm-bp1h7rc0991ojh36h.mysql.rds.aliyuncs.com;port=3306;dbname=cd_finance2|changdong|Changdong123!@#',
