...
//         $url ="https://open.weixin.qq.com/connect/oauth2/authorize?appid=$appid&redirect_uri='http://test.mobile.bestdaming.cn/getUserInfo'&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect";
