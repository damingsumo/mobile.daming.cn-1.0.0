{include file="common/header.tpl" pageTitle="创建身材"}
  ...
  <div class="bottom3">
    ...
    {foreach $hairStyles as $hairStyle}
      <li value="{$hairStyle.hair_style_id}" {if $hairStyle.hair_style_id == $image.hair_style_id} class="bg3" {/if}><img src="{$hairStyle.picture_url}"><span>{$hairStyle.name}</span></li>
      {/foreach}
    </ul>
