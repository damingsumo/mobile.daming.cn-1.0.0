...
<?php
class CoreApi_Image_Face extends CoreApi {

    protected static $instance__; //必要,
    protected $_module = 'yd_res';
    protected $_tableName = 'face';
    protected $_primaryKey = 'face_id';
     ...
     * @param string $desc
     */
    public function getFacesByParams($params, $page, $pagesize, $returnFormat = 'Array', $order = "create_time", $desc = "desc") {
